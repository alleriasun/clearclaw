...
**When identity is included:** For group workspaces (non-default), the orchestrator prepends sender identity to the prompt: `[Paddy (@paddybot)]: the message`. This lets Claude distinguish speakers in multi-user group chats.
